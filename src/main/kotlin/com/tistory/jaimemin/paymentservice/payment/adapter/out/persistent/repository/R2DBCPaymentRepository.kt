...
import com.tistory.jaimemin.paymentservice.payment.domain.PendingPaymentOrder
...
class R2DBCPaymentRepository(
    ...
    override fun save(paymentEvent: PaymentEvent): Mono<Void> {
        return insertPayment(paymentEvent)
            .flatMap {
                selectPaymentEventId()
            }
    ...
    private fun insertPayment(paymentEvent: PaymentEvent): Mono<Long> {
